...
namespace SauceLabsTestProject
{
    public class GanttPageLoad_Level1
    {
        ...
        [Test]
        public void TestGanttPagelink12()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink13()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink14()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink15()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink16()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink17()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
        ...
        [Test]
        public void TestGanttPagelink18()
        {
            driver.Navigate().GoToUrl("https://mc-adsqaweb02.bstsoftware.net:444/project/ca00dde5-a981-08d3-e007-bfd4dea8627c/task");
            Thread.Sleep(TimeSpan.FromMinutes(1));
            CheckForPageLoad();
